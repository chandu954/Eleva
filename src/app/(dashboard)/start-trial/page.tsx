      ...
      <main className="relative z-10 container mx-auto px-4 py-12 max-w-5xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Try Eleva Pro free for 7 days. Cancel anytime before your trial ends and you won&apos;t be charged.
          </p>
        </motion.div>
          ...
          >
            <div className="bg-white rounded-2xl border border-purple-200 p-8 shadow-xl relative overflow-hidden">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Eleva Pro</h3>
