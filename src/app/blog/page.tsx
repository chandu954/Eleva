...
export const metadata: Metadata = {
  title: "Eleva Blog",
  description: "Latest updates, tips, and articles from the Eleva team.",
};
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Discover the latest tips, product updates, and insights from our team as we help you elevate your career with AI.
          </p>
        </div>
